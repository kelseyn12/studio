...
- `app/` routes: Today, pipeline, plan, calendar, campaigns, cards, CapCut in, library, repurposer, transcriber, dms, analytics, connections, team, sign-in/sign-up
...
- `lib/` prisma, pipeline, deals, next-action, session, Clerk, R2, Outstand, analytics, formats, rewrite, whisper, manychat, ffmpeg, variations, combinations, editor-packet, queries, publish, media-url
