...
- `components/` shell, nav, pills, action card, studio map, batch settings, clip tile
- `lib/` prisma, pipeline, deals, next-action, session, Outstand, ffmpeg, variations, combinations, queries
