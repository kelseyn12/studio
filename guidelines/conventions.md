...
- Voice, phone clips, and 1080 exports live on Cloudflare R2. This Mac only holds them if R2 keys are missing. ffmpeg scratch uses temp files. 4K days stay a Drive folder link.
