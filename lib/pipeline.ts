...
> = {
  ...
  EDITING: { label: "Editing", owner: "Editor", color: "edit", next: "REVIEW" },
  REVIEW: { label: "Review", owner: "Creator", color: "review", next: "READY" },
  READY: { label: "Ready", owner: "Operator", color: "ready", next: "POSTED" },
  POSTED: { label: "Posted", owner: "Operator", color: "live", next: "DATA" },
  DATA: { label: "Data", owner: "Creator", color: "data" },
};
